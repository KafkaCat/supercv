    ...
    <aside className="w-16 flex flex-col items-center py-4 gap-4 border-r border-slate-800 bg-slate-900 z-20">
      ...
      <div className="flex flex-col gap-3 w-full px-2">
        ...
        <button 
          ...
          className="p-3 text-slate-400 hover:text-white hover:bg-slate-800 rounded-xl flex flex-col items-center gap-1 transition-colors w-full group" 
          title="AI Optimizer"
        >
          <Icon name="auto_awesome" className="group-hover:text-purple-400 transition-colors" />
        </button>
      </div>
